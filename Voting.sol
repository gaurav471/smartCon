...
// "vote")
    ...
    // this flag will help to keep track of 1 voter - 1 vote 8
    ...
    * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
    ...
    function vote(uint candidateID) public {
        ...
        require(!voters[msg.sender].hasVoted, "Respective Voter has already voted.");
        require(voters[msg.sender].isAuthorized, "Respective Voter is not authorized to vote.");
    ...
    * * * * * * * * * * * * * * * * * * * * * * * * * */
    ...
    function getCandidate(uint candidateID) public view returns (uint,string memory, string memory, uint) { return
        (candidateID,candidates[candidateID].name,candidates[candidateID].party,candidates[candidateID].noOFVotes);
    }
    
    function Authorize(address _Voter) onlyOwner public {
        //only owner of this cotract can authorize a voter add a modifier here to achive this (Example : onlyOwner) 
